...
#ifndef SV_CODE_GEN
DEFINE_MODEL_INTERFACE(CommutatorEnv)
{
	SET_MODEL_DESCRIPTION("Synchronous Data Commutator (Envelope)");
	SET_MODEL_SYMBOL("SYM_Commutator");
	SET_MODEL_CATEGORY("Routers/Resamplers");

	ADD_MODEL_HEADER_FILE("SystemVue/Models/CommutatorEnv.h");
...
CommutatorEnv::CommutatorEnv()
	: BlockSize(1),
	m_iBlockSize(1u)
{
}

bool CommutatorEnv::Setup()
{
