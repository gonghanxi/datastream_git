...
class COMM_AntennaPolarizationRx : public SystemVueModelBuilder::TimedDFModel
{
public:
	DECLARE_MODEL_INTERFACE(COMM_AntennaPolarizationRx);
...
private:
	struct PatternPoint
	{
		...
		std::complex<double> Gtheta; // theta/V receive response component
		std::complex<double> Gphi;   // phi/H receive response component
	};
