...
#ifndef SV_CODE_GEN
DEFINE_MODEL_INTERFACE ( RADAR_PhasedArrayTx )
{	
...
RADAR_PhasedArrayTx::RADAR_PhasedArrayTx()
{

}

bool RADAR_PhasedArrayTx::Setup()
{
	bool bStatus = true;
...
bool RADAR_PhasedArrayTx::Run()
{
	...
	{
	// 线阵
	case RADAR_PhasedArrayTx::UniformLinearArray:
	{
		// NumOfAnt1D 阵元数量
		// D 阵元间距
		// 声明阵元坐标
		...
		switch (SpaceType)
		{
		case RADAR_PhasedArrayTx::Uniform:
			...
			break;
		case RADAR_PhasedArrayTx::NonUniform:
	...
	// 面阵
	case RADAR_PhasedArrayTx::UniformRectangularArray:
	{
		// 声明阵元坐标
