...
#ifndef SV_CODE_GEN
DEFINE_MODEL_INTERFACE ( BSF_Butterworth )
{	
	SET_MODEL_DESCRIPTION("Bandstop Butterworth Filter");
...
BSF_Butterworth::BSF_Butterworth()
{

}

ERESULT BSF_Butterworth::PropagateCharacterizationFrequency()
{
	bool bStatus = true;
...
// 计算 exp(j * 2 * PI * f_c * t)
std::complex<double> BSF_Butterworth::complexExponential(double f_c, double t) {
	// 计算角频率：ω = 2 * π * f_c
...
// 分贝转倍数
double BSF_Butterworth::dBToPowerRatio(double dB) {
