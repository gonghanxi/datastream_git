...
#ifndef SV_CODE_GEN
DEFINE_MODEL_INTERFACE(DistributorEnv)
{
	SET_MODEL_DESCRIPTION("Synchronous Data Distributor (Envelope)");
...
DistributorEnv::DistributorEnv()
	: BlockSize(1)
	, m_iBlockSize(1)
{
}

bool DistributorEnv::Setup()
{
	if (BlockSize < 1)
		m_iBlockSize = 1;
	else
