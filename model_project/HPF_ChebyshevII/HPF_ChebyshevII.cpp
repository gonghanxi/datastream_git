...
#ifndef SV_CODE_GEN
DEFINE_MODEL_INTERFACE ( HPF_ChebyshevII )
{	
	SET_MODEL_DESCRIPTION("Highpass Chebyshev II Filter");
...
HPF_ChebyshevII::HPF_ChebyshevII()
{

}

ERESULT HPF_ChebyshevII::PropagateCharacterizationFrequency()
{
	bool bStatus = true;
...
// 计算 exp(j * 2 * PI * f_c * t)
std::complex<double> HPF_ChebyshevII::complexExponential(double f_c, double t) {
	// 计算角频率：ω = 2 * π * f_c
...
// 分贝转倍数
double HPF_ChebyshevII::dBToPowerRatio(double dB) {
