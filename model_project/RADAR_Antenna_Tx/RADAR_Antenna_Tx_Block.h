#ifndef RADAR_ANTENNA_TX_BLOCK_H
#define RADAR_ANTENNA_TX_BLOCK_H
...
class SYSTEMVUEMODELBUILDER_API RADAR_Antenna_Tx_Block : public SystemVueModelBuilder::Block
{
public:
    RADAR_Antenna_Tx_Block(const std::string& name);
    ~RADAR_Antenna_Tx_Block() = default;
...
private:
    ...
    // enums
    using SelectedRadarWorkMode       = RADAR_Antenna_Tx::SelectedRadarWorkMode;
    using SelectedPattern             = RADAR_Antenna_Tx::SelectedPattern;
    using SelectedAntennaScanPattern  = RADAR_Antenna_Tx::SelectedAntennaScanPattern;
    ...
    std::unique_ptr<RADAR_Antenna_Tx> m_ant;
...
RegAlgo(RADAR_Antenna_Tx_Block);
