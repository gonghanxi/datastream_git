...
{
    qDebug() << "RectToCx_Block::Run - begin";
    ...
    qDebug() << "RectToCx_Block::Run - DComplexData size: " << DComplexData.size();
    return true;
}
...
//    qDebug() << "RectToCx_Block::RunBatch-- usage" << usage;
//    qDebug() << "RectToCx_Block::RunBatch-- 最终执行batchSize" << batchSize;
    ...
    qDebug() << "RectToCx_Block::RunBatch - outputData size: " << outputData.size();
    return batchSize;
}
