...
#ifndef SV_CODE_GEN
DEFINE_MODEL_INTERFACE ( HPF_ChebyshevI )
{	
	SET_MODEL_DESCRIPTION("Highpass Chebyshev I Filter");
...
HPF_ChebyshevI::HPF_ChebyshevI()
{

}

ERESULT HPF_ChebyshevI::PropagateCharacterizationFrequency()
{
	bool bStatus = true;
...
// 计算 exp(j * 2 * PI * f_c * t)
std::complex<double> HPF_ChebyshevI::complexExponential(double f_c, double t) {
	// 计算角频率：ω = 2 * π * f_c
...
// 分贝转倍数
double HPF_ChebyshevI::dBToPowerRatio(double dB) {
