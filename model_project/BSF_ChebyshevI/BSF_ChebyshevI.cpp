...
#ifndef SV_CODE_GEN
DEFINE_MODEL_INTERFACE ( BSF_ChebyshevI )
{	
	SET_MODEL_DESCRIPTION("Bandstop Chebyshev I Filter");
...
BSF_ChebyshevI::BSF_ChebyshevI()
{

}

ERESULT BSF_ChebyshevI::PropagateCharacterizationFrequency()
{
	bool bStatus = true;
...
// 计算 exp(j * 2 * PI * f_c * t)
std::complex<double> BSF_ChebyshevI::complexExponential(double f_c, double t) {
	// 计算角频率：ω = 2 * π * f_c
...
// 分贝转倍数
double BSF_ChebyshevI::dBToPowerRatio(double dB) {
