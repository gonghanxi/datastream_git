...
#ifndef SV_CODE_GEN
DEFINE_MODEL_INTERFACE ( CyclicShiftCx )
{	
...
CyclicShiftCx::CyclicShiftCx()
{

}

bool CyclicShiftCx::Setup()
{
	bool bStatus = true;
	...
	if (Offset <= -BlockSize || Offset >= BlockSize)
	{
        ...
        LOG_ERROR("Offset must be: -BlockSize < Offset < Blocksize");
		bStatus = false;
	}
