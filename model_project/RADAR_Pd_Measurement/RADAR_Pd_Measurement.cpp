...
#ifndef SV_CODE_GEN
DEFINE_MODEL_INTERFACE ( RADAR_Pd_Measurement )
{	
	SET_MODEL_DESCRIPTION("Detection Probability Estimation");
...
RADAR_Pd_Measurement::RADAR_Pd_Measurement()
{
	
}

bool RADAR_Pd_Measurement::Setup()
{
	bool bStatus = true;
...
bool RADAR_Pd_Measurement::Finalize()
{
	outputFile << "[" << "\r\n";
	outputFile << "\t{" << "\r\n";
